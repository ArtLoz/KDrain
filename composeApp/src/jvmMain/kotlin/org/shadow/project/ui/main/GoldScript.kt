...
import com.kbridge.utils.test.GpsNavigator
import com.l2bot.bridge.api.L2Bot
import kotlinx.coroutines.delay

// ==================== Paths & Zones ====================

private const val SCRIPT_PATH = "C:\\softt\\Scripts\\EO_path\\"
private val GPS_DB = ResourceHelper.getDatabasePath()

private const val GOLD_ZONE = "${SCRIPT_PATH}GOLD_ZONE.zmap"
private const val GOLD_CONFIG = "${SCRIPT_PATH}GOLD_CONFIG.xml"
private const val GOLEM_ZONE = "${SCRIPT_PATH}GOLEM_ZONE.zmap"
private const val GOLEM_CONFIG = "${SCRIPT_PATH}GOLEM_CONFIG.xml"
private const val E_TEMP_ZONE = "${SCRIPT_PATH}E_RUINES_ZONE.zmap"
private const val E_TEMP_CONFIG = "${SCRIPT_PATH}TEMP_CONFIG.xml"
private const val SPIDER_ZONE = "${SCRIPT_PATH}SPIDER_ZONE.zmap"
private const val SPIDER_CONFIG = "${SCRIPT_PATH}SPIDER_CONFIG.xml"
private const val WINDI_ZONE = "${SCRIPT_PATH}WINDI_HIL.zmap"
private const val WINDI_CONFIG = "${SCRIPT_PATH}WINDI_CONFIG.xml"
private const val ONE_STEP_ZONE = "${SCRIPT_PATH}EO_STEP_ONE.zmap"
private const val ONE_TWO_ZONE = "${SCRIPT_PATH}EO_STEP_TWO.zmap"
private const val ONE_STEP_CONFIG = "${SCRIPT_PATH}EO_STEP_ONE.xml"
...
suspend fun goldScript(bot: L2Bot) {
